...
class LinkGorgiasWithPHP {
    ...
    public function __construct() {
        ...
        $this->deltaExplanation['r1'] = 'Normally, we sell a product at its <u>high price.</u>';
        $this->deltaExplanation['p2p3'] = 'Normally, we sell a product at its high price ,but because the <b>customer is regular, he can have late delivery and he pays in cash <u>we prefer to sell the product at the lower price.</u></b>';

        $this->deltaExplanation['p2'] = 'Normally, we sell a product at its high price ,but because <b>the customer is regular and he pays in cash <u>we prefer to sell the product at the lower price.</u></b>';
        $this->deltaExplanation['p3'] = 'Normally, we sell a product at its high price, but because <b>the buyer can have late delivery, and he pays in cash <u>we prefer to sell the product at the lower price.</u></b>';
        $this->deltaExplanation['c2c4'] = 'Generally when the customer is regular  ,he can have late delivery and he pays in cash we prefer to sell the product at the lower price, but because <b>we are in high season <u>we   must sell the product at high price.</u></b>';

        $this->deltaExplanation['c2'] = 'Generally when the customer is regular  and he pays in cash we prefer to sell the product at the lower price, but because <b> we are in high season <u>we   must sell the product at high price.</u></b>';
        $this->deltaExplanation['c4'] = 'Generally when the buyer can have late delivery, and he pays in cash we prefer to sell the product at the lower price,   but because<b> we are in high season <u>we   must sell the product at high price.</u></b>';
    }
    ...
    public function executeGorgias($productId, $customerId, $regularCustomer, $payCash, $lateDelivery, $highSeason) {
	//Create prolog API object instance
        $prologApiInstance = new PrologControllerApi();
		
	//Configure HTTP basic authorization: basicAuth

		$prologApiInstance->getConfig()->setUsername("your username");
        $prologApiInstance->getConfig()->setPassword("your password");
	...
	//consultFileUsingPOST("your gorgias policy file, "your project name) 
        ...
        $result = $prologApiInstance->consultFileUsingPOST("seller.pl", "seller");
